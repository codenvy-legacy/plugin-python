...
@Singleton
public class PythonProjectTypeExtension implements ProjectTypeExtension {
    private static final Logger LOG = LoggerFactory.getLogger(PythonProjectTypeExtension.class);
    ...
    public PythonProjectTypeExtension(ProjectTypeDescriptionRegistry registry,
        ...
        this.projectType = new ProjectType(ProjectAttributes.PYTHON_ID, ProjectAttributes.PYTHON_NAME, ProjectAttributes.PYTHON_CATEGORY, null,
                                           ProjectAttributes.PYTHON_WEB_DEF_RUNNER);
